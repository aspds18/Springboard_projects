...
SELECT DISTINCT CONCAT( members.surname,  ' ', members.firstname ) AS member, 
CASE WHEN signups.facid =0
THEN  'Tennis Court 1'
WHEN signups.facid =1
THEN  'Tennis Court 2'
ELSE  'other'
END AS  'tenniscourt'
FROM  `Members` AS members
JOIN  `Bookings` AS signups ON members.memid = signups.memid
